      ...
      <div class="row">
        ...
        <nav class="col--md-8 col-sm-8 col-xs-8">
          ...
          <div class="main-menu">
            ...
            <ul>
              <li><a href="https://mercadocotia.com/">CONHEÇA IT Menu</a></li>
              <li><a href="<?=$site;?>vendas">LOGISTA - ENTENDA O SISTEMA</a></li>
  ...
  <section class="parallax-window" id="home" data-parallax="scroll" data-image-src="sub_header_cart.jpg" data-natural-width="1400" data-natural-height="350">
   ...
   <div id="subheader">
      ...
      <div id="sub_content">
        ...
        <p>
          Os melhores cardápios estão aqui. IT Menu Delivery, Descubra!
        </p>
  ...
  <div class="row">
    ...
    <div class="col-md-6 nopadding">
      <div class="features-content">
        <h3>A fome Bateu? IT Menu Delivery te Ajuda</h3>
        <ul class="list_ok">
          <li> Restaurantes</li>
          <li> Bares</li>
          <li> Pizzarias</li>
...
<div class="high_light">
  <div class="container">
    ...
    <a href="https://delivery3.mercadocotia.tech/">VEJA AS VANTAGENS DO NOSSO SISTEMA</a>
  </div><!-- End container -->
</div><!-- End hight_light -->
