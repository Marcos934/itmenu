            ...
            <div class="principal">
                <div class="container">
                    <div class="flutua">
                        ...
                        <a href="<?=$site;?>sobre" class="login"><i class="fas fa-user-circle"></i><img src="img/686317.png" width="15px"> Sobre</a>
                        <a href="<?=$site;?>login" class="login"><i class="fas fa-user-circle"></i><img src="img/seta-button.png" width="15px"> Entrar</a>
                    </div>
                    <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 conteudo owl wow fadeInRight">
                ...
                <p>A plataforma IT Menu Delivery foi desenvolvida para você criar seu <strong>cardápio ou catálogo on-line completo</strong> e receber seus <strong>pedidos via WhatsApp</strong>. Edite seu cardápio ou catálogo a qualquer momento direto do seu celular ou computador.</p>
            </div>
        </div>
    </div>
</section>
